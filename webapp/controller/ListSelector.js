sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("ns.expMD.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias ns.expMD.controller.ListSelector
			 */
			 ...
			 * @return {ns.expMD.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
