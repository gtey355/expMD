...
sap.ui.define([
	...
	opaTest("MasterList Filtering on custid less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog("<custid>").
	...
	opaTest("MasterList Filtering on custid more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog(">100 <>").
			and.iPressOKInViewSelectionDialog();
