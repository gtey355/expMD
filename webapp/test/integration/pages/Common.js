sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("ns/expMD/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("ns.expMD.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ns/expMD/localService/mockserver"], function (mockserver) {
