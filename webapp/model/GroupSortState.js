sap.ui.define([
	...
	return BaseObject.extend("ns.expMD.model.GroupSortState", {
		 ...
		 * @alias ns.expMD.model.GroupSortState
		 */
		...
		/**
		 * Sorts by custname, or by custid
		 *
		...
		/**
		 * Groups by custid, or resets the grouping for the key "None"
		 *
		 * @param {string} sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function (sKey) {
			...
			if (sKey === "custid") {
				...
				this._oViewModel.setProperty("/sortBy", "custid");

				aSorters.push(
					new Sorter("custid", false,
